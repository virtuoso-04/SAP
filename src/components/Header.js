    ...
    <header className="bg-white shadow-sm sticky top-0 z-30">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center min-w-0">
          ...
          <span className="ml-2 text-xs font-medium text-sap-grey rounded-full bg-sap-light-grey px-2 py-0.5 whitespace-nowrap">
            IPX Hub
          </span>
        </div>
        ...
        <nav className="hidden md:block">
          <ul className="flex items-center space-x-6">
            ...
            <li>
              <Link to="/networking" className="text-sap-grey hover:text-sap-blue transition-colors">
                Networking
              </Link>
            </li>
            <li>
        ...
        {/* Mobile compact nav (optional future) */}
      </div>
    </header>
  );
};
