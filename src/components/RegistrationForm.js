...
const RegistrationForm = () => {
  ...
  const handleChange = (e) => {
    ...
    // Keep full_name in sync with first/last name
    if (name === 'first_name' || name === 'last_name') {
      const first = name === 'first_name' ? value : next.first_name;
      const last = name === 'last_name' ? value : next.last_name;
      next.full_name = `${(first || '').trim()} ${(last || '').trim()}`.trim();
    }
  ...
  const step1Fields = ['first_name', 'last_name', 'email', 'mobile', 'category'];
  ...
  const handleNextStep = () => {
    const stepsValidation = {
      1: ['first_name', 'last_name', 'email', 'mobile'],
      2: formData.category === 'Professional' 
        ? ['company', 'designation', 'country', 'gender'] 
        : ['college', 'year', 'country', 'gender']
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        food_choice: formData.food_choice,
      ...
      const response = await apiService.registerAttendee(payload);
  ...
  <div className="px-6 sm:px-8 pt-8 pb-4">
      ...
      <form onSubmit={handleSubmit}>
        <AnimatePresence mode="wait">
          {currentStep === 1 && (
            <motion.div
              ...
              className="space-y-8 px-6 sm:px-8 pb-8"
            >
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-4 sm:gap-5">
                  <motion.div 
                    className={`border-2 p-6 sm:p-8 rounded-2xl cursor-pointer transition-all flex flex-col items-center justify-center ${
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 sm:gap-y-5">
                    ...
                    <motion.div
                      ...
                      whileHover="hover"
                    >
                      <label className="block text-sm font-medium text-gray-600 mb-1.5 ml-0.5" htmlFor="year">
                      ...
                      <div className="relative">
                        ...
                        >
                          <select
                            ...
                            onBlur={handleInputBlur}
                            className={`w-full px-4 py-3 bg-white rounded-xl text-base border-2 appearance-none
                              ${focusedField === 'year' ? 'border-sap-blue shadow-sm ring-2 ring-sap-blue/20' : errors.year ? 'border-red-400 ring-2 ring-red-200' : 'border-gray-200'} 
                              focus:outline-none focus:border-sap-blue transition-all duration-200`}
                            required
                          >
                            {[1,2,3,4,5].map(y => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-4 gap-3">
                        {[{label: 'Undergraduate', value: 'UG'}, {label: 'Postgraduate', value: 'PG'}, {label: 'PhD', value: 'PhD'}, {label: 'Other', value: 'Other'}].map((opt) => (
                          <motion.div
                            key={opt.value}
                            ...
                            whileTap={{ scale: 0.98 }}
                            onClick={() => handleChange({ target: { name: 'education_level', value: opt.value } })}
                          >
                            {opt.label}
                          </motion.div>
                        ))}
          ...
          {currentStep === 3 && (
            ...
            >
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3 sm:mb-4">
        ...
        {currentStep < 3 && (
          <div className="flex justify-between mt-8 px-6 sm:px-8 pb-8">
            {currentStep > 1 ? (
              <motion.button
                type="button"
