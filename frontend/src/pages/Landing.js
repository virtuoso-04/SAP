  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-sap-blue text-center mb-12">Key Features</h2>
      ...
      {/* CTA Section */}
      <section className="bg-sap-blue text-white rounded-sap p-8 text-center">
        ...
        <Link to="/register" className="btn bg-white text-sap-blue hover:bg-sap-bg px-8 py-3 font-medium">
          Register Now
        </Link>
      </section>
    </div>
